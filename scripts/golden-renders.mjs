...
import { loadProject } from "../apps/studio/src/projectIo.ts";
import { generateSceneThumbnails } from "../apps/studio/src/thumbs.ts";
...
const dir = path.resolve(process.argv[2] ?? "projects/Starter");
