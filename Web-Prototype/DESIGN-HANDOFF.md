# fa323ac0-cb1a-49bd-b1f3-4f915aee77c9 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `archive/duplicate-import/index.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `archive/duplicate-import/index.html`
...
- A single self-contained `archive/duplicate-import/index.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `archive/duplicate-import/index.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `archive/duplicate-import/index.html`
- `reference-ui/index.html`
- `sequences-phase-1-studio.html`

## Styles
- `archive/duplicate-import/styles.css`
- `reference-ui/styles.css`

## Scripts/components
- `archive/duplicate-import/agent.jsx`
- `archive/duplicate-import/components.jsx`
- `archive/duplicate-import/data.js`
- `archive/duplicate-import/inspector.jsx`
- `archive/duplicate-import/preview.jsx`
- `archive/duplicate-import/timeline.jsx`
- `reference-ui/agent.jsx`
- `reference-ui/components.jsx`
- `reference-ui/data.js`
- `reference-ui/inspector.jsx`
- `reference-ui/preview.jsx`
- `reference-ui/timeline.jsx`
...
1. Inspect `archive/duplicate-import/index.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
