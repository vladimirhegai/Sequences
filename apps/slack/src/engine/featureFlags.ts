...
export const OPERATIONAL_ENV_REGISTRY = {
  ...
  SLACK_SEQUENCES_PROVIDER: operational(
    "auto (CLI login, then Anthropic API when configured)",
    ["<registered provider id>"],
    "orchestrator",
    "Select the planning/authoring provider.",
    "Unset to restore provider auto-detection.",
    "Provider routing is required runtime configuration, not staged feature rollout.",
  ),
